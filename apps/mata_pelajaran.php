        ...
        <div class="row">
          <?php while($row = mysqli_fetch_assoc($result1)) { ?>
            <div class="col-12 col-md-11 mx-auto">
              <div class="col">
                <div class="card rounded-4 mb-3 mapel" style="width: 100%;">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img src="data:image;base64,<?php echo base64_encode($row['gambar_cover']); ?>" class="img-fluid rounded-3 p-3" alt="image">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body ml-3">
                        ...
                        <p class="card-text">
                          <small class="text-muted">
                            ...
                            Guru Pengajar: <?php echo $row['guru_pengajar1']; ?>, <?php echo $row['guru_pengajar2']; ?>, <?php echo $row['guru_pengajar3']; ?>
                          </small>
                        </p>
                        <p class="card-text">
                          <?php echo $row['konten']; ?>
