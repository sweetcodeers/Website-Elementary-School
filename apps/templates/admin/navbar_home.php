      ...
      <nav class="navbar navbar-expand-lg border-0 navbar-light bg-white fixed-top" id="myNav">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-lg-0">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-0 shadow" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="<?php echo BASE; ?>admin/sejarah.php">Sejarah Singkat</a></li>
            ...
            <form class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
              <?php
                  $user_id = $_SESSION['id'];
