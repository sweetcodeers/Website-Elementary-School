        ...
        <div class="card mb-3 p-4">
          <div class="row g-0">
            ...
            <div class="col-md-4 mb-4">
              <img src="/smpn2karanganyar/media/image/visi.jpg" class="img-fluid rounded-start" alt="visi image">
            </div>
            <div class="col-md-8">
              <div class="card-body">
            ...
            <div class="col-md-5">
              <img src="/smpn2karanganyar/media/image/misi.jpg" class="img-fluid rounded-start" alt="misi image">
            </div>
            <!-- Tujuan Sekolah -->
            <div class="col-md-5">
              <img src="/smpn2karanganyar/media/image/tujuan.jpg" class="img-fluid rounded-start" alt="tujuan image">
            </div>
            <div class="col-md-7">
              <div class="card-body">
