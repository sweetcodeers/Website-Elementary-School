    ...
    <div class="container-fluid">
      <div class="container" style="margin-top: 50px;">
        <div class="card rounded-3 border-0 mb-5" style="width: 100%;background-color: #F2F2F2;">
          <div class="card-body">
            <p class="card-title fs-2 fw-bold">Berita</p>
            <p class="card-text">Berita SMPN 2 Karanganyar</p>

            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo BASE; ?>">Home</a></li>
                <li class="breadcrumb-item active">Media & Informasi</li>
                <li class="breadcrumb-item active text-dark fw-bold" aria-current="page">Berita</li>
              </ol>
            </nav>
          </div>
        </div>
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                      <a href="<?php echo BASE; ?>berita_detail.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mt-2 mb-1">
                        Baca selengkapnya
                      </a>
                    </div>
                  </div>
